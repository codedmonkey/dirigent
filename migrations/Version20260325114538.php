...
final class Version20260325114538 extends AbstractMigration
{
    ...
    private function createMetadataTables(): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
                metadata_keyword
            ADD
                CONSTRAINT FK_C8E2A1C3DC9EE959 FOREIGN KEY (metadata_id) REFERENCES metadata (id) ON DELETE CASCADE NOT DEFERRABLE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
                metadata_keyword
            ADD
                CONSTRAINT FK_C8E2A1C3115D4552 FOREIGN KEY (keyword_id) REFERENCES keyword (id) NOT DEFERRABLE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
    ...
    private function fillMetadataTables(): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO metadata_keyword (metadata_id, keyword_id, index)
            SELECT metadata.id, version_keyword.keyword_id, version_keyword.index
