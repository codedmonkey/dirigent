...
final class Version20240903123717 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE access_token (id INT GENERATED BY DEFAULT AS IDENTITY, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE conflict_link (id INT GENERATED BY DEFAULT AS IDENTITY, version_id INT NOT NULL, package_name VARCHAR(191) NOT NULL, package_version TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CA65041A4BBC2705 ON conflict_link (version_id)');
        $this->addSql('CREATE TABLE credentials (id INT GENERATED BY DEFAULT AS IDENTITY, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, username VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE dev_require_link (id INT GENERATED BY DEFAULT AS IDENTITY, version_id INT NOT NULL, package_name VARCHAR(191) NOT NULL, package_version TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_47A9DC2B4BBC2705 ON dev_require_link (version_id)');
        $this->addSql('CREATE TABLE package (id INT GENERATED BY DEFAULT AS IDENTITY, repository_credentials_id INT DEFAULT NULL, mirror_registry_id INT DEFAULT NULL, name VARCHAR(191) NOT NULL, vendor VARCHAR(191) NOT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, readme TEXT DEFAULT NULL, abandoned BOOLEAN NOT NULL, replacement_package VARCHAR(255) DEFAULT NULL, repository_type VARCHAR(255) DEFAULT NULL, repository_url VARCHAR(255) DEFAULT NULL, remote_id VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, update_scheduled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, dumped_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE provide_link (id INT GENERATED BY DEFAULT AS IDENTITY, version_id INT NOT NULL, package_name VARCHAR(191) NOT NULL, package_version TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1F4B1A734BBC2705 ON provide_link (version_id)');
        $this->addSql('CREATE TABLE registry (id INT GENERATED BY DEFAULT AS IDENTITY, credentials_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, url VARCHAR(1024) NOT NULL, package_mirroring VARCHAR(255) NOT NULL, mirroring_priority INT NOT NULL, dynamic_update_delay VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE replace_link (id INT GENERATED BY DEFAULT AS IDENTITY, version_id INT NOT NULL, package_name VARCHAR(191) NOT NULL, package_version TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8DB462154BBC2705 ON replace_link (version_id)');
        $this->addSql('CREATE TABLE require_link (id INT GENERATED BY DEFAULT AS IDENTITY, version_id INT NOT NULL, package_name VARCHAR(191) NOT NULL, package_version TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_705971CE4BBC2705 ON require_link (version_id)');
        $this->addSql('CREATE TABLE reset_password_request (id INT GENERATED BY DEFAULT AS IDENTITY, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7CE748AA76ED395 ON reset_password_request (user_id)');
        $this->addSql('COMMENT ON COLUMN reset_password_request.requested_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN reset_password_request.expires_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE suggest_link (id INT GENERATED BY DEFAULT AS IDENTITY, version_id INT NOT NULL, package_name VARCHAR(191) NOT NULL, package_version TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D4DEADF74BBC2705 ON suggest_link (version_id)');
        $this->addSql('CREATE TABLE tag (id INT GENERATED BY DEFAULT AS IDENTITY, name VARCHAR(191) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "user" (id INT GENERATED BY DEFAULT AS IDENTITY, username VARCHAR(80) NOT NULL, name VARCHAR(180) DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON "user" (email)');
        $this->addSql('CREATE TABLE version (id INT GENERATED BY DEFAULT AS IDENTITY, package_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, normalized_version VARCHAR(191) NOT NULL, description TEXT DEFAULT NULL, readme TEXT DEFAULT NULL, homepage VARCHAR(255) DEFAULT NULL, development BOOLEAN NOT NULL, license JSON NOT NULL, type VARCHAR(255) DEFAULT NULL, target_dir VARCHAR(255) DEFAULT NULL, source JSON DEFAULT NULL, dist JSON DEFAULT NULL, autoload JSON NOT NULL, binaries JSON DEFAULT NULL, include_paths JSON DEFAULT NULL, php_ext JSON DEFAULT NULL, authors JSON DEFAULT NULL, support JSON DEFAULT NULL, funding JSON DEFAULT NULL, extra JSON DEFAULT NULL, default_branch BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, released_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE messenger_messages (id BIGSERIAL GENERATED BY DEFAULT AS IDENTITY, body TEXT NOT NULL, headers TEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, available_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
