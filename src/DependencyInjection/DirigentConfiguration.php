    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode->children()
            ...
            ->arrayNode('encryption')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('private_key')->defaultValue('%kernel.project_dir%/config/encryption/private.key')->end()
                    ->scalarNode('public_key')->defaultValue('%kernel.project_dir%/config/encryption/public.key')->end()
