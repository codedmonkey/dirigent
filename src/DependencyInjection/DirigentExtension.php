...
class DirigentExtension extends ConfigurableExtension
{
    ...
    private function registerDistributionsConfiguration(array $config, array $distMirroringConfig, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('dirigent.distributions.dev_versions', $config['dev_versions'] || ($distMirroringConfig['enabled'] && $distMirroringConfig['dev_packages']));
        $container->setParameter('dirigent.distributions.preferred_mirror', $config['preferred_mirror'] || ($distMirroringConfig['enabled'] && $distMirroringConfig['preferred']));
    }
