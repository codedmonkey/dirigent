 ...
 *     },
 * }
 * @psalm-type DirigentConfig = array{
 *     title?: scalar|Param|null, // Default: "My Dirigent"
 *     slug?: scalar|Param|null, // Default: null
 *     security?: array{
 *         public?: bool|Param, // Default: false
 *         registration?: bool|Param, // Default: false
 *     },
 *     encryption?: array{ // Dirigent uses a X25519 keypair to encrypt sensitive info stored in the database
 *         private_key?: scalar|Param|null, // The (private) decryption key, if empty, a file will be used to store the key instead // Default: null
 *         private_key_path?: scalar|Param|null, // Path to the (private) decryption key if private_key is empty // Default: "%kernel.project_dir%/config/encryption/private.key"
 *         public_key?: scalar|Param|null, // The (public) encryption key, if empty, a file will be used to store the key instead // Default: null
 *         public_key_path?: scalar|Param|null, // Path to the (public) encryption key if public_key is empty // Default: "%kernel.project_dir%/config/encryption/public.key"
 *         rotated_keys?: Param|string|list<scalar|Param|null>,
 *         rotated_key_paths?: Param|string|list<scalar|Param|null>,
 *     },
 *     storage?: array{
 ...
 *             dev_versions?: bool|Param, // Retain pruned development package versions. // Default: false
 *         },
 *         retain_stale_revisions?: bool|array{
 *             enabled?: bool|Param, // Retain stale revisions of package versions. // Default: true
 *             tagged_versions?: bool|Param, // Retain stale revisions of tagged package versions. // Default: true
 *             dev_versions?: bool|Param, // Retain stale revisions of development package versions. // Default: false
 *         },
 *     },
 *     packages?: array{
 *         dynamic_updates?: bool|Param, // Whether to automatically update packages when using the (Composer) API // Default: true
 *         dynamic_update_delay?: string|Param, // The delay between package updates when using the API, in ISO 8601 duration format // Default: "PT4H"
 *         periodic_updates?: bool|Param, // Whether to automatically update packages periodically // Default: true
 *         periodic_update_interval?: string|Param, // The interval between periodic package updates, in ISO 8601 duration format // Default: "P1W"
 *     },
 * }
